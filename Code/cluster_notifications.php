...
$stmt = $db->prepare('SELECT id, date, time, region, postal_code, town, content FROM notifications WHERE postal_code != "" WHERE cluster = NULL ORDER BY date ASC, time ASC');
$stmt->execute();
