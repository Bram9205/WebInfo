...
if( parsed["exists"])
	...
	RestClient.post "http://localhost:9200/news/article/"+id.to_s , {"tokonized_text:" => parsed["_source"]["tokonized_text:"],"text:" => parsed["_source"]["text:"], "datum:" => parsed["_source"]["datum:"], "title:" => parsed["_source"]["title:"],  "locatie:" => parsed["_source"]["locatie:"], "label:" => label }.to_json, :content_type => :json, :accept => :json
end
